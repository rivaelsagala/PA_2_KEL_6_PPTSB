    ...
    <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
        <ul class="flex flex-wrap items-center gap-2 mb-3 font-normal text-15">
            <li
                ...
                <a href="/admin-anggota" class="text-slate-500 dark:text-zink-200">Anggota</a>
            </li>
    ...
    <div id="edit" modal-center=""
        ...
        <div class="w-screen lg:w-[55rem] bg-white shadow rounded-md dark:bg-zink-600 flex flex-col h-full">
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form class="create-form" id="create-form" action="/admin-edit-anggota-proses/{{ $anggota->id_anggota }}"
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-12">
                        ...
                        <div class="xl:col-span-4">
                            ...
                            <input type="text" id="gelar_belakang" value="{{ $anggota->gelar_belakang }}"
                                name="gelar_belakang"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                        ...
                        <div class="xl:col-span-4">
                            ...
                            <input type="text" id="nama_depan" value="{{ $anggota->nama_depan }}" name="nama_depan"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                placeholder="Nama Depan">
                        </div>
                        <div class="xl:col-span-4">
                            <label for="fromInput" class="inline-block mb-2 text-base font-medium">Nama Belakang</label>
                            <input type="text" id="nama_belakang" value="{{ $anggota->nama_belakang }}"
                                name="nama_belakang"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                        ...
                        <div class="xl:col-span-4">
                            ...
                            <div>
                                <input type="file" name="foto" value="{{ $anggota->foto }}"
                        ...
                        <div class="xl:col-span-4">
                            ...
                            <input type="text" id="no_telepon" name="no_telepon" value="{{ $anggota->no_telepon }}"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                        ...
                        <div class="xl:col-span-4">
                            <div>
                                ...
                                <select class="form-input border-slate-200 focus:outline-none focus:border-custom-500"
                                    data-choices="" data-choices-search-false="" name="pekerjaan" id="pekerjaan">
                                    <option value="">Pilih Pekerjaan</option>
                                    @foreach ($pekerjaans as $pekerjaan)
                                        <option value="{{ $pekerjaan->id_pekerjaan }}"
                                            {{ $pekerjaan->id_pekerjaan == $anggota->id_pekerjaan ? 'selected' : '' }}>
                        ...
                        <div class="xl:col-span-4">
                            <div>
                                ...
                                <select class="form-input border-slate-200 focus:outline-none focus:border-custom-500"
                                    data-choices="" data-choices-search-false="" name="pendidikan" id="pendidikan">
                                    <option value="">Pilih Pendidikan</option>
                                    @foreach ($pendidikans as $pendidikan)
                                        <option value="{{ $pendidikan->id_pendidikan }}"
                                            {{ $pendidikan->id_pendidikan == $anggota->id_pendidikan ? 'selected' : '' }}>
                        ...
                        <div class="xl:col-span-4">
                            ...
                            <input type="text" id="keterangan" value="{{ $anggota->keterangan }}" name="keterangan"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
