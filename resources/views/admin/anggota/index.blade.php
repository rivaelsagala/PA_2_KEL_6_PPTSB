                        ...
                        <tr>
                            ...
                            <td
                                ...
                                <div class="flex gap-3">
                                    <a href="/admin-edit-anggota/{{ $d->id_anggota }}"
                                    ...
                                    <form id="deleteForm_{{ $d->id_anggota }}"
                                        action="/admin-anggota-keaktifan/{{ $d->id_anggota }}" method="POST">
                                        @csrf
                                        @method('POST')
                                        <button type="submit"
    ...
    <div id="tambah" modal-center=""
        ...
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form class="create-form" id="create-form" action="/admin-tambah-anggota" method="POST"
