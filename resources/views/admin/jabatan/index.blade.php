...
@section('content')
    <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
        <div class="grow">
            <h5 class="text-16">Halaman Jabatan</h5>
        </div>
        <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
            <li
                class="relative before:content-['\ea54'] before:font-remix ltr:before:-right-1 rtl:before:-left-1  before:absolute before:text-[18px] before:-top-[3px] ltr:pr-4 rtl:pl-4 before:text-slate-400 dark:text-zink-200">
                <a href="/jabatan" class="text-slate-400 dark:text-zink-200">Jabatan</a>
            </li>
        </ul>
    </div>
    ...
    <div class="card" id="employeeTable">
        <div class="card-body">
            <div class="flex items-center gap-3 mb-4">
                <h6 class="text-15 grow">Total Jabatan (<b class="total-Employs">{{ $totalData }}</b>)</h6>
                <div class="shrink-0">
                        ...
                        <tr>
                            ...
                            <td
                                ...
                                <div class="flex items-center gap-3">
                                    <h6 class="grow">{{ $d->nama_jabatan }}</h6>
                                </div>
                            </td>
                            <td
                                class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500 Name">
                            ...
                            <td
                                ...
                                <div class="flex gap-3">
                                    <a href="/edit/jabatan-halaman/{{ $d->id_jabatan }}"
                                    ...
                                    {{-- 
                            <form id="deleteForm_{{$d->id_jabatan}}"
                                action="/delete/jabatan/{{$d->id_jabatan}}" method="POST">
                                @csrf
                                <button type="submit"
                                    ...
                                    <form id="deleteForm_{{ $d->id_jabatan }}"
                                        action="{{ url('/delete/jabatan/' . $d->id_jabatan) }}" method="POST">
                                        @csrf
                                        <button type="submit"
                ...
                <form class="create-form" id="create-form" action="/tambah-jabatan" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                        <div class="xl:col-span-12">
                            <label for="nama_jabatan" class="inline-block mb-2 text-base font-medium">Nama Jabatan</label>
                            <input type="text" id="nama_jabatan" name="nama_jabatan"
                                ...
                                placeholder="Masukkan Jabatan" required title="Harap isi bidang ini">
                        </div>
                        ...
                        <select
                            ...
                            name="jenis_status" id="jenisStatus">
                            <option value="">Pilih Jenis Status</option>
                            @foreach ($jenisStatus as $jenis)
                            <option value="{{ $jenis->jenis_status }}">{{ $jenis->jenis_status }}</option>
                            @endforeach
                        </select>
                    </div> --}}
                    </div>
                                ...
                                <label
                                    ...
                                    <span class="flex h-full gap-0">
                                        ...
                                        <span class="grow">
                                            <span class="flex flex-col h-full">
                                                <span
                                                    class="block h-3 border-b border-slate-200 dark:border-zink-500"></span>
                                                <span
