    ...
    <div class="card" id="employeeTable">
        <div class="card-body">
            <div class="flex items-center gap-3 mb-4">
                <h6 class="text-15 grow">Jenis Status (<b class="total-Employs">{{ $totalData }}</b>)</h6>
                <div class="shrink-0">
                        ...
                        <tr>
                            ...
                            <td
                                ...
                                <div class="flex gap-3">
                                    <a href="/edit/jenis-status-halaman/{{ $d->id_jenis_status }}"
                                    ...
                                    <form id="deleteForm_{{ $d->id_jenis_status }}"
                                        action="{{ url('/delete/jenis-status/' . $d->id_jenis_status) }}" method="POST">
                                        @csrf
                                        <button type="submit"
