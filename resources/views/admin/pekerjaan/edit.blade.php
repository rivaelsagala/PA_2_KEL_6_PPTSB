...
<div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
    <ul class="flex flex-wrap items-center gap-2 mb-3 font-normal text-15">
        <li
            ...
            <a href="/pekerjaan" class="text-slate-500 dark:text-zink-200">pekerjaan</a>
        </li>
...
<div id="Edit" modal-center=""
    ...
    <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
        <div class="flex items-center justify-beSTEen p-4 border-b dark:border-zink-500">
            <h5 class="text-16" id="addEmployeeLabel">Edit Pekerjaan</h5>
        </div>
        <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">

            <form class="create-form" id="create-form" action="/edit-pekerjaan/{{$data->id_pekerjaan}}" method="POST">
                @csrf
                <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                    <div class="xl:col-span-12">
                        <label for="pekerjaan" class="inline-block mb-2 text-base font-medium">Pekerjaan</label>
                        <input value="{{$data->nama_pekerjaan}}" type="text" id="nama_pekerjaan" name="nama_pekerjaan"
                ...
                <div class="flex justify-end gap-2 mt-4">
                    ...
                    <button type="submit" id="addNew"
                        class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">Edit Pekerjaan</button>
                </div>
            </form>
        </div>
    </div>
