    ...
    <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
        <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
            <li
                ...
                <a href="/pekerjaan" class="text-slate-400 dark:text-zink-200">Jenis Pekerjaan</a>
            </li>
        </ul>
    </div>
    ...
    <div class="card" id="employeeTable">
        <div class="card-body">
            <div class="flex items-center gap-3 mb-4">
                <h6 class="text-15 grow">Pekerjaan (<b class="total-Employs">{{ $totalData }}</b>)</h6>
                <div class="shrink-0">
                        ...
                        <tr>
                            ...
                            <td
                                ...
                                <a href="#!" class="flex items-center gap-3">
                                    <h6 class="grow">{{ $d->nama_pekerjaan }}</h6>
                                </a>
                            </td>
                            ...
                            <td
                                ...
                                <div class="flex gap-3">
                                    <a href="/edit/pekerjaan-halaman/{{ $d->id_pekerjaan }}"
                                    ...
                                    {{-- <form id="deleteForm_{{$d->id_pekerjaan}}"
                                        action="/delete/pekerjaan/{{$d->id_pekerjaan}}" method="POST">
                                        @csrf
                                        <button type="submit"
                                    ...
                                    <form id="deleteForm_{{ $d->id_pekerjaan }}"
                                        action="{{ url('/delete/pekerjaan/' . $d->id_pekerjaan) }}" method="POST">
                                        @csrf
                                        <button type="submit"
    ...
    <div id="Tambah" modal-center=""
        ...
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            <div class="flex items-center justify-beSTEen p-4 border-b dark:border-zink-500">
                <h5 class="text-16" id="addEmployeeLabel">Tambah Pekerjaan</h5>
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                ...
                <form class="create-form" id="create-form" action="/tambah-pekerjaan" method="POST">
                    @csrf
