...
@section('content')
    <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
        <div class="grow">
            <h5 class="text-16">Halaman Pendidikan</h5>
        </div>
        <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
            <li
                class="relative before:content-['\ea54'] before:font-remix ltr:before:-right-1 rtl:before:-left-1  before:absolute before:text-[18px] before:-top-[3px] ltr:pr-4 rtl:pl-4 before:text-slate-400 dark:text-zink-200">
                <a href="/pendidikan" class="text-slate-400 dark:text-zink-200">Pendidikan</a>
            </li>
        </ul>
    </div>
    ...
    <div class="card" id="tambah">
        <div class="card-body">
            <div class="flex items-center gap-3 mb-4">
                <h6 class="text-15 grow">Total Tingkat Pendidikan (<b class="total-Employs">{{ $totalData }}</b>)</h6>
                <div class="shrink-0">
                        ...
                        <tr>
                            ...
                            <td
                                ...
                                <div class="flex gap-3">
                                    ...
                                    {{-- <form id="deleteForm_{{$d->id_pendidikan}}"
                                action="/delete/pendidikan/{{$d->id_pendidikan}}" method="POST">
                                @csrf
                                <button type="submit"
                                    ...
                                    <form id="deleteForm_{{ $d->id_pendidikan }}"
                                        action="{{ url('/delete/pendidikan/' . $d->id_pendidikan) }}" method="POST">
                                        @csrf
                                        <button type="submit"
    ...
    <div id="Tambah" modal-center=""
        ...
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            <div class="flex items-center justify-beSTEen p-4 border-b dark:border-zink-500">
                <h5 class="text-16" id="addEmployeeLabel">Tambah Tingkat Pendidikan</h5>
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                ...
                <form class="create-form" id="create-form" action="/tambah-pendidikan" method="POST">
                    @csrf
                    <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                        <div class="xl:col-span-12">
                            <label for="pendidikan" class="inline-block mb-2 text-base font-medium">Tingkat
                                Pendidikan</label>
