    ...
    <div id="Edit" modal-center=""
        ...
        <div class="w-screen lg:w-[55rem] bg-white shadow rounded-md dark:bg-zink-600 flex flex-col h-full mt-6">
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form class="create-form" id="create-form" action="/admin-edit-pengumuman/{{ $kegiatan->id_kegiatan }}"
                    ...
                    <d iv class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                        <div class="xl:col-span-6">
                            ...
                            <input value="{{ $kegiatan->nama_kegiatan }}" type="text" id="nama_kegiatan"
                                name="nama_kegiatan"
                        ...
                        <div class="xl:col-span-6">
                            ...
                            <input value="{{ $kegiatan->nama_aksi_sosial }}" type="text" id="nama_aksi_sosial"
                                name="nama_aksi_sosial"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                placeholder="nama pengumuman" required>
                        </div>
                        <div class="xl:col-span-6">
                        ...
                        <div class="md:col-span-2 xl:col-span-6">
                            <div>
                                <label for="reasonInput" class="inline-block mb-2 text-base font-medium">Jumlah
                                    Bantuan</label>
                                <input type="number" value="{{ $kegiatan->jumlah_bantuan }}" id="phoneNumberInput"
                                    value="jumlah_bantuan" name="jumlah_bantuan"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                        ...
                        <div class="md:col-span-2 xl:col-span-6">
                            <div>
                                <label for="reasonInput"
                                    class="inline-block mb-2 text-base font-medium">Keterangan</label>
                                <input value="{{ $kegiatan->keterangan }}" type="text" id="keterangan"
                                    name="keterangan"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                            ...
                            <select name="id_anggota" id="id_anggota"
                                ...
                                @foreach ($anggota as $d)
                                    <option value="{{ $d->id_anggota }}"
                                        {{ $d->id_anggota == $d->id_anggota ? 'selected' : '' }}>{{ $d->nama_depan }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
