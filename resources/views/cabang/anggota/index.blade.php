...
<div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
    <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
        <li
            ...
            <a href="#!" class="text-slate-400 dark:text-zink-200">Anggota</a>
        </li>
    </ul>
</div>
{{-- lisss --}}
                ...
                <tr>
                    ...
                    <td
                        ...
                        <div class="flex gap-3">
                            <a href="/cabang-edit-anggota/{{ $d->id_anggota }}"
                            ...
                            <form id="deleteForm_{{$d->id_anggota}}"
                                action="/cabang-anggota/{{ $d->id_anggota }}/toggle-status" method="POST">
                                @csrf
                                @method('POST')
