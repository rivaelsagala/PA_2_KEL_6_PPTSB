...
<div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
    <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
        <li
            ...
            <a href="#!" class="text-slate-400 dark:text-zink-200">Cabang</a>
        </li>
    </ul>
</div>
{{-- lisss --}}
<div class="card" id="employeeTable">
    <div class="card-body">
        <div class="flex items-center gap-3 mb-4">
            <h6 class="text-15 grow">Data Regional (<b class="total-Employs">{{$totalData}}</b>)</h6>
        </div>
            <table id="rowBorder" style="width:100%">
                ...
                <tbody lass="divide-y divide-slate-200 dark:divide-zink-500">
                    @foreach ($data as $d)
                    <tr>
                        <td
                        ...
                        <td
                            ...
                            <a href="#!" class="flex items-center gap-3">
                                <h5 class="grow">{{$d->kode_cabang}}</h5>
                            </a>
                        </td>
                        ...
                        <td
                            ...
                            <div class="flex gap-3">
                                <a href="{{ route('cabang.edit', $d->id_cabang) }}"
