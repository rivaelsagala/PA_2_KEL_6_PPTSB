...
<div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
    <ul class="flex flex-wrap items-center gap-2 mb-3 font-normal text-15">
        <li class="relative before:content-['\ea54'] before:font-remix before:ltr:-right-1 before:rtl:-left-1 before:absolute before:text-[18px] before:-top-[3px] ltr:pr-4 rtl:pl-4 before:rtl:rotate-180 before:text-slate-500 dark:before:text-zink-200">
            <a href="/cabang-kepala_keluarga" class="text-slate-500 dark:text-zink-200">Kepala Keluarga</a>
        </li>
...
<div class="w-screen lg:w-[55rem] bg-white shadow rounded-md dark:bg-zink-600 flex flex-col h-full">
        <div class="flex items-center justify-between p-4 border-b dark:border-zinc-500">
            <h5 class="text-16" id="addEmployeeLabel">Edit Kepala Keluarga</h5>
        </div>
        <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
        <form class="create-form" id="create-form" action="/cabang-edit-kepala_keluarga-proses/{{ $anggota->id_anggota }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-12">
                    <div class="xl:col-span-4">
                        <label for="fromInput" class="inline-block mb-2 text-base font-medium">Gelar Depan</label>
                        <input type="text" id="gelar_depan" value="{{ $anggota->gelar_depan }}"  name="gelar_depan" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Gelar Depan">
                    </div>
                    <div class="xl:col-span-4">
                        <label for="fromInput" class="inline-block mb-2 text-base font-medium">Gelar Belakang</label>
                        <input type="text" id="gelar_belakang" value="{{ $anggota->gelar_belakang }}" name="gelar_belakang" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Gelar Belakang">
                    </div>
                    <div class="xl:col-span-4">
                        <label for="fromInput" class="inline-block mb-2 text-base font-medium">Nama Depan</label>
                        <input type="text" id="nama_depan" value="{{ $anggota->nama_depan }}" name="nama_depan" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Nama Depan">
                    </div>
                    <div class="xl:col-span-4">
                        <label for="fromInput" class="inline-block mb-2 text-base font-medium">Nama Belakang</label>
                        <input type="text" id="nama_belakang" value="{{ $anggota->nama_belakang }}" name="nama_belakang" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Nama Belakang">
                    </div>
                    <div class="xl:col-span-4">
                        <label for="foto" class="inline-block mb-2 text-base font-medium">Foto</label>
                        <div>
                            <input type="file" name="foto" value="{{ $anggota->foto }}" class="cursor-pointer form-file border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500" placeholder="Foto" >
                        </div>
                    </div>
                    <div class="xl:col-span-4">
                        <label for="fromInput" class="inline-block mb-2 text-base font-medium">Alamat</label>
                        <input type="text" id="alamat" name="alamat" value="{{ $anggota->alamat }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Alamat">
                    </div>
                    <div class="xl:col-span-4">
                        <label for="fromInput" class="inline-block mb-2 text-base font-medium">Tempat Lahir</label>
                        <input type="text" id="tempat_lahir" name="tempat_lahir" value="{{ $anggota->tempat_lahir }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Tempat Lahir">
                    </div>
                    <div class="xl:col-span-4">
                        <label for="fromInput" class="inline-block mb-2 text-base font-medium">No Telepon</label>
                        <input type="text" id="no_telepon" name="no_telepon" value="{{ $anggota->no_telepon }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="No Telepon">
                    </div>
                    <div class="xl:col-span-4">
                        <label for="status" class="inline-block mb-2 text-base font-medium">Status</label>
                        <select class="form-input border-slate-200 focus:outline-none focus:border-custom-500" name="status" id="status">
                            <option value="">Pilih Status</option>
                            @foreach($statuses as $status)
                            <option value="{{ $status->id_status }}" {{ $status->id_status == $anggota->id_status ? 'selected' : '' }}>{{ $status->keterangan }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="xl:col-span-3">
                        <div>
                            <label for="leaveType" class="inline-block mb-2 text-base font-medium">Pekerjaan</label>
                            <select class="form-input border-slate-200 focus:outline-none focus:border-custom-500" data-choices="" data-choices-search-false="" name="pekerjaan" id="pekerjaan">
                                <option value="">Pilih Pekerjaan</option>
                                @foreach($pekerjaans as $pekerjaan)
                                <option value="{{ $pekerjaan->id_pekerjaan }}" {{ $pekerjaan->id_pekerjaan == $anggota->id_pekerjaan ? 'selected' : '' }}>{{ $pekerjaan->nama_pekerjaan }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div><!--end col-->
                    <div class="xl:col-span-3">
                        <div>
                            <label for="leaveType" class="inline-block mb-2 text-base font-medium">Pendidikan</label>
                            <select class="form-input border-slate-200 focus:outline-none focus:border-custom-500" data-choices="" data-choices-search-false="" name="pendidikan" id="pendidikan">
                                <option value="">Pilih Pendidikan</option>
                                @foreach($pendidikans as $pendidikan)
                                <option value="{{ $pendidikan->id_pendidikan }}" {{ $pendidikan->id_pendidikan == $anggota->id_pendidikan ? 'selected' : '' }}>{{ $pendidikan->tingkat_pendidikan }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div><!--end col-->
                    <div class="xl:col-span-3">
                        <div>
                            <label for="leaveType" class="inline-block mb-2 text-base font-medium">Hubungan Keluarga</label>
                            <select class="form-input border-slate-200 focus:outline-none focus:border-custom-500" data-choices="" data-choices-search-false="" name="hubungan_keluarga" id="hubungan_keluarga">
                                <option value="">Pilih Hubungan Keluarga</option>
                                @foreach($hubunganKeluargas as $keluarga)
                                <option value="{{ $keluarga->id_hubungan_keluarga }}" {{ $keluarga->id_hubungan_keluarga == $anggota->id_hubungan_keluarga ? 'selected' : '' }}>{{ $keluarga->keterangan }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div><!--end col-->
                    <div class="xl:col-span-3">
                        <label for="fromInput" class="inline-block mb-2 text-base font-medium">Keterangan</label>
                        <input type="text" id="keterangan" value="{{ $anggota->keterangan }}" name="keterangan" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Keterangan">
                    </div>
                </div><!--end grid-->
