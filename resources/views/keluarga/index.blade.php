...
<div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
    <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
        <div class="grow">
            <h5 class="text-16">Parsadaan Pomparan Toga Sinaga Dohot Boru (PPTSB)</h5>
        </div>
    ...
    <div class="relative card-body" style="background-color: black;padding: 20px">
        <div class="grid items-center grid-cols-12">
            <div class="col-span-12 lg:col-span-8 2xl:col-span-7">
                <h5 class="mb-3 font-normal tracking-wide text-slate-200">Selamat datang di PPTSB 🎉
                </h5>
                <p class="mb-5 text-slate-400">Dasbor PPTSB ini memberi tim
                    gambaran umum yang jelas tentang informasi PPTSB dan situs web utama kapan saja.
                </p>
            </div>
            <div class="hidden col-span-12 2xl:col-span-3 lg:col-span-2 lg:col-start-11 2xl:col-start-10 lg:block">
                <img style="border-radius: 10px" src="{{asset('assets/gambar/logopptsb1.jpg')}}" alt="" class="h-40 ltr:2xl:ml-auto rtl:2xl:mr-auto">
            </div>
        </div>
    </div>
...
<div class="grid grid-cols-12 2xl:grid-cols-12 gap-x-5" style="margin-top: 50px; margin-bottom: 50px">
    <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
        <div class="text-center card-body">
            ...
            <h5 class="mt-4 mb-2"><span class="counter-value" data-target="{{$totalregional}}">0</span></h5>
            <p class="text-slate-500 dark:text-zink-200">Regional</p>
        </div>
    </div><!--end col-->
    <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
        <div class="text-center card-body">
            ...
            <h5 class="mt-4 mb-2"><span class="counter-value" data-target="{{$totalcabang}}">0</span></h5>
            <p class="text-slate-500 dark:text-zink-200">Pusat</p>
        </div>
    </div><!--end col-->
    <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
        <div class="text-center card-body">
            ...
            <h5 class="mt-4 mb-2"><span class="counter-value" data-target="{{$totalcabang}}">0</span></h5>
            <p class="text-slate-500 dark:text-zink-200">Cabang</p>
        </div>
    </div><!--end col-->
    <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
        <div class="text-center card-body">
            ...
            <h5 class="mt-4 mb-2"><span class="counter-value" data-target="{{$totalsektor}}">0</span></h5>
            <p class="text-slate-500 dark:text-zink-200">Sektor</p>
        </div>
    </div><!--end col-->
</div><!--end grid-->
