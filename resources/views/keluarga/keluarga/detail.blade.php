...
<div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
    <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
        <li
            ...
            <a href="/keluarga-dashboard" class="text-slate-400 dark:text-zink-200">PPTSB</a>
        </li>
                ...
                <tbody class="list" id="employeeList">
                    <tr>
                        ...
                        <span class="px-2.5 py-0.5 inline-block text-xs font-medium rounded border 
                                @if($kepala_keluarga->status == 'Aktif') 
                ...
                <tr>
                    ...
                    <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500 Action">
                        <div class="flex gap-3">
                            <a href="/keluarga-edit-anggota/{{ $d->id_anggota }}" class="flex items-center justify-center transition-all duration-200 ease-linear rounded-md size-8 edit-item-btn bg-slate-100 text-slate-500 hover:text-custom-500 hover:bg-custom-100 dark:bg-zink-600 dark:text-zink-200 dark:hover:bg-custom-500/20 dark:hover:text-custom-500"><i data-lucide="pencil" class="size-4"></i></a>
                            <form id="deleteForm_{{$d->id_anggota}}"
                                action="/anggota-aktif/{{ $d->id_anggota }}" method="POST">
                                @csrf
                                @method('POST')
...
<div id="addEmployeeModal" modal-center=""
    ...
    <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
        ...
        <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
            <form class="create-form" id="create-form" action="/keluarga-pindah-sektor" method="POST"
...
<div id="tambah" modal-center="" class="fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show ">
    <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
        ...
        <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
            <form class="create-form" id="create-form" action="/keluarga-tambah-anggota" method="POST" enctype="multipart/form-data">
                @csrf
