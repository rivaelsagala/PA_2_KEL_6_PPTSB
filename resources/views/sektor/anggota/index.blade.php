...
<div class="card" id="employeeTable">
    <div class="card-body">
        <div class="flex items-center gap-3 mb-4">
            <h6 class="text-15 grow">Data Anggota (<b class="total-Employs">{{$totalData}}</b>)</h6>
            <div class="shrink-0">
                ...
                <tr>
                        ...
                        <a href="#!" class="flex items-center gap-3">
                            <div class="w-6 h-6 rounded-full shrink-0 bg-slate-100">
                                <a href="assets/gambar/{{$d->foto}}">
                                    <img src="assets/gambar/{{$d->foto}}" alt="" class="h-6 rounded-full"></a>
                    ...
                    <td
                        ...
                        <div class="flex gap-3">
                            <a href="{{ route('anggota.edit', $d->id_anggota) }}"
                            ...
                            <form id="deleteForm_{{$d->id_anggota}}"
                                action="{{ route('anggota.keaktifan', $d->id_anggota) }}" method="POST">
                                @csrf
                                @method('POST')
...
<div id="tambah" modal-center=""
    ...
    <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
        ...
        <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
            <form class="create-form" id="create-form" action="/tambah-anggota" method="POST"
                enctype="multipart/form-data">
                @csrf
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-12">
                    <div class="xl:col-span-6">
                        <label for="gelar_depan" class="inline-block mb-2 text-base font-medium">Gelar
                            Depan</label>
                    ...
                    <div class="xl:col-span-6">
                        <label for="nama_depan" class="inline-block mb-2 text-base font-medium">Nama
                            Depan</label>
                    ...
                    <div class="xl:col-span-6">
                        <label for="tempat_lahir" class="inline-block mb-2 text-base font-medium">Tempat
                            Lahir</label>
                    ...
                    <div class="xl:col-span-6">
                        <label for="no_telepon" class="inline-block mb-2 text-base font-medium">No
                            Telepon</label>
                    ...
                    <div class="xl:col-span-6">
                        <label for="id_registrasi" class="inline-block mb-2 text-base font-medium">Kepala
                            Keluarga</label>
                        <select
                            class="form-input border-slate-200 focus:outline-none focus:border-custom-500 dark:focus:border-custom-800"
                            name="id_registrasi" id="id_registrasi">
                            <option value="">Pilih Kepala Keluarga</option>
                            @foreach($registrasiAnggota as $registrasi)
                            <option value="{{ $registrasi->id_registrasi }}">{{ $registrasi->nama_depan }}
                            </option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="xl:col-span-6">
                        ...
                        <select
                            ...
                            <option value="{{ $pendidikan->id_pendidikan }}">{{ $pendidikan->tingkat_pendidikan
                                }}
                            </option>
                            @endforeach
                        </select>
