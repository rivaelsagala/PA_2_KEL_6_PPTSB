            ...
            <div class="shrink-0">
                <a href="#!" data-modal-target="addEmployeeModal" type="button"
                    class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20 add-employee"><i
                        data-lucide="plus" class="inline-block size-4"></i> <span class="align-middle">Pindah
                        Sektor</span></a>
            </div>
        </div>
                ...
                <tbody class="list" id="employeeList">
                    <tr>
                        <td
                            ...
                            <a href="#!"
                                class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600">#STE{{$kepala_keluarga->id_kepala_keluarga}}</a>
                        </td>
                        <td
...
<div class="card" id="employeeTable">
    <div class="card-body">
        <div class="flex items-center gap-3 mb-4">
            ...
            <div class="shrink-0">
                <a href="#!" data-modal-target="tambah" type="button" class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20 add-employee"><i data-lucide="plus" class="inline-block size-4"></i> <span class="align-middle">Tambah Anggota</span></a>
            </div>
        </div>
            ...
            <tbody class="list" id="employeeList">
                ...
                <tr>
                    <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500 ID">
                        <a href="#!"
                            class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600">#STE{{$d->id_anggota}}</a>
                    </td>
                    ...
                    <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500 Name">
                        <a href="#!" class="flex items-center gap-3">
                            <div class="w-6 h-6 rounded-full shrink-0 bg-slate-100">
                                <img src="/assets/gambar/{{ $d->foto }}" alt="" class="h-6 rounded-full">
                            </div>
                            {{$d->nama_depan}}
                        </a>
                    </td>
                    ...
                    <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500 Action">
                        <div class="flex gap-3">
                            <a href="{{ route('sektor.anggota.edit', $d->id_anggota) }}" class="flex items-center justify-center transition-all duration-200 ease-linear rounded-md size-8 edit-item-btn bg-slate-100 text-slate-500 hover:text-custom-500 hover:bg-custom-100 dark:bg-zink-600 dark:text-zink-200 dark:hover:bg-custom-500/20 dark:hover:text-custom-500"><i data-lucide="pencil" class="size-4"></i></a>
                            <form id="deleteForm_{{$d->id_anggota}}"
                                action="{{ route('sektor.anggota.keaktifan', $d->id_anggota) }}" method="POST">
                                @csrf
                                @method('POST')
                                <button type="submit" class="toggle-status flex items-center justify-center text-white  transition-all duration-200 ease-linear rounded-md size-8 hover:text-white  
                                     ...
                                     @endif">
                                    @if($d->id_status == 1)
                                    <i data-lucide="check" class="size-4"></i> <!-- Icon untuk aktifkan -->
                                    @else
                                    <i data-lucide="x" class="size-4"></i> <!-- Icon untuk nonaktifkan -->
                                    @endif
                                </button>
                            </form>
                        </div>
...
<div id="addEmployeeModal" modal-center=""
    ...
    <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
        <div class="flex items-center justify-between p-4 border-b dark:border-zink-500">
            <h5 class="text-16" id="addEmployeeLabel">Pindah Sektor</h5>
        ...
        <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
            <form class="create-form" id="create-form" action="/pindah-sektor" method="POST"
                ...
                <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                    <div class="xl:col-span-12">
                        <label for="no_reg_pindah" class="inline-block mb-2 text-base font-medium">No Reg Pindah</label>
                        <input type="text" id="no_reg_pindah" name="no_reg_pindah"
                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                            placeholder="No Reg Pindah" required>
                    </div>
                    <div class="xl:col-span-6">
                        <label for="joiningDateInput" class="inline-block mb-2 text-base font-medium">Tanggal
                            Pindah</label>
                        <input type="text" id="joiningDateInput" name="tgl_pindah"
                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                            placeholder="Pilih Tanggal" data-provider="flatpickr" data-date-format="d M, Y">
                    </div>
                    <div class="xl:col-span-6">
                        <label for="file_surat_pindah" class="inline-block mb-2 text-base font-medium">File Surat
                            Pindah</label>
                        <div>
                            <input type="file" id="file_surat_pindah" name="file_surat_pindah"
                    ...
                    <input type="hidden" name="id_anggota" value="{{ $kepala_keluarga->id_anggota }}">
                    <input type="hidden" name="id_registrasi" value="{{ $registrasi_id }}">
                    <div class="xl:col-span-12">
                        <label for="sektor_tujuan" class="inline-block mb-2 text-base font-medium">Sektor tujuan</label>
                        <select
                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                            name="sektor_tujuan" id="sektor_tujuan" required>
                            <option value="">Pilih Sektor Tujuan</option>
                ...
                <div class="flex justify-end gap-2 mt-4">
                    ...
                    <button type="submit" id="addNew"
                        class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">Tambah</button>
                </div>
            </form>
        </div>
    </div>
...
<div id="tambah" modal-center="" class="fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show ">
    <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
        ...
        <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
            <form class="create-form" id="create-form" action="/tambah-anggota" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-12">
                    <div class="xl:col-span-6">
                        ...
                        <input type="text" id="gelar_depan" name="gelar_depan" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Gelar Depan">
                    </div>
                    <div class="xl:col-span-6">
                        <label for="gelar_belakang" class="inline-block mb-2 text-base font-medium">Gelar Belakang</label>
                        <input type="text" id="gelar_belakang" name="gelar_belakang" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Gelar Belakang">
                    </div>
                    <div class="xl:col-span-6">
                        <label for="nama_depan" class="inline-block mb-2 text-base font-medium">Nama Depan</label>
                        <input type="text" id="nama_depan" name="nama_depan" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Nama Depan">
                    </div>
                    <div class="xl:col-span-6">
                        <label for="nama_belakang" class="inline-block mb-2 text-base font-medium">Nama Belakang</label>
                        <input type="text" id="nama_belakang" name="nama_belakang" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Nama Belakang">
                    </div>
                    <div class="xl:col-span-6">
                        <label for="foto" class="inline-block mb-2 text-base font-medium">Foto</label>
                        <div>
                            <input type="file" id="foto" name="foto" class="cursor-pointer form-file border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 dark:focus:border-custom-800" required>
                        </div>
                    </div>
                    <div class="xl:col-span-6">
                        <label for="alamat" class="inline-block mb-2 text-base font-medium">Alamat</label>
                        <input type="text" id="alamat" name="alamat" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Alamat">
                    </div>
                    <div class="xl:col-span-6">
                        <label for="tempat_lahir" class="inline-block mb-2 text-base font-medium">Tempat Lahir</label>
                        <input type="text" id="tempat_lahir" name="tempat_lahir" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Tempat Lahir">
                    </div>
                    <div class="xl:col-span-6">
                        <label for="no_telepon" class="inline-block mb-2 text-base font-medium">No Telepon</label>
                        <input type="text" id="no_telepon" name="no_telepon" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="No Telepon">
                    </div>
                    <input type="hidden" name="id_registrasi" value="{{ $registrasi_id }}">
                    ...
                    <div class="xl:col-span-6">
                        <div>
                            ...
                            <select class="form-input border-slate-200 focus:outline-none focus:border-custom-500 dark:focus:border-custom-800" name="sektor" id="sektor">
                    ...
                    <div class="xl:col-span-6">
                        ...
                        <select class="form-input border-slate-200 focus:outline-none focus:border-custom-500 dark:focus:border-custom-800" name="status" id="status">
                    ...
                    <div class="xl:col-span-6">
                        ...
                        <select class="form-input border-slate-200 focus:outline-none focus:border-custom-500 dark:focus:border-custom-800" name="pekerjaan" id="pekerjaan">
                    ...
                    <div class="xl:col-span-6">
                        ...
                        <select class="form-input border-slate-200 focus:outline-none focus:border-custom-500 dark:focus:border-custom-800" name="pendidikan" id="pendidikan">
                            <option value="">Pilih Pendidikan</option>
                            @foreach($pendidikans as $pendidikan)
                            <option value="{{ $pendidikan->id_pendidikan }}">{{ $pendidikan->tingkat_pendidikan }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="xl:col-span-6">
                        <label for="keterangan" class="inline-block mb-2 text-base font-medium">Keterangan</label>
                        <input type="text" id="keterangan" name="keterangan" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Keterangan">
                    </div>
                </div>
                <div class="flex justify-end gap-2 mt-4">
                    <button type="reset" class="text-red-500 bg-white btn hover:text-red-500 hover:bg-red-100 dark:bg-zink-700 dark:hover:bg-red-500/10">Reset</button>
                    <button type="submit" class="text-white btn bg-custom-500 border-custom-500 hover:bg-custom-600 dark:hover:bg-custom-600 dark:ring-custom-400/20">Tambah Anggota</button>
                </div>
            </form>
        </div>
    </div>
