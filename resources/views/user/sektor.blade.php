                            ...
                            <div class="main-container fl-wrap fix-container-init">
                                @foreach ($sektor as $d)
                                    <div class="section-title" style="margin-bottom: 10px;">
                                        <h2>Sektor {{ $d->nama_sektor }}</h2>
                                    </div>
                                    <div class="list-post-wrap" style="margin-bottom: 70px;">
                                        <!--list-post-->
                                        <table>
                                            <tr>
                                                <td class="label-tabel">Ketua</td>
                                                <td>:</td>
                                                <td class="isitabel">{{ $d->nama_depan }} {{ $d->nama_belakang }}</td>
                                            </tr>
                                            <tr>
                                                <td class="label-tabel">Alamat</td>
                                                <td>:</td>
                                                <td class="isitabel">{{ $d->alamat_sektor }}</td>
                                            </tr>
                                            <tr>
                                                <td class="label-tabel">Tanggal Berdiri</td>
                                                <td>:</td>
                                                <td class="isitabel"><i class="far fa-clock"></i> {{ $d->tgl_berdiri }}</td>
                                            </tr>
                                        </table>
                                    </div>
                                @endforeach
